...
time.sleep(3)
print("support currently for https and socks5")
print("RememberURLSchemesAreAllLowerCase")
bitter = input("EnterProtocolType.ie.http,https,socks5,etc:")
listofprotocols = ["https", "socks5"] ##trying to verifiy if valid url scheme
for licker in listofprotocols:
    print("comparing %s with %s: %s" % (licker, listofprotocols, licker == bitter))
